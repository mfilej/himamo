defmodule Himamo.BaumWelch.StepETest do
  ...
  test "compute_alpha" do
    ...
    expected = [
      {{0, 0}, log(0.21000000000)},
      {{0, 1}, log(0.24000000000)},
      {{1, 0}, log(0.10260000000)},
      {{1, 1}, log(0.01080000000)},
      {{2, 0}, log(0.02138400000)},
      {{2, 1}, log(0.00421200000)},
      {{3, 0}, log(0.00664848000)},
      {{3, 1}, log(0.00089748000)},
      {{4, 0}, log(0.00143904600)},
      {{4, 1}, log(0.00027491400)},
      {{5, 0}, log(0.00033325506)},
      {{5, 1}, log(0.00048248784)},
      {{6, 0}, log(0.00019025763)},
      {{6, 1}, log(1.8155081e-05)},
    ] |> Enum.into(Map.new)
  ...
  test "compute_beta" do
    ...
    expected = [
      {{0, 0}, log(0.00041202932)},
      {{0, 1}, log(0.00050786063)},
      {{1, 0}, log(0.00179934800)},
      {{1, 1}, log(0.00220366700)},
      {{2, 0}, log(0.00779480000)},
      {{2, 1}, log(0.00990710000)},
      {{3, 0}, log(0.02652800000)},
      {{3, 1}, log(0.03570200000)},
      {{4, 0}, log(0.12920000000)},
      {{4, 1}, log(0.08180000000)},
      {{5, 0}, log(0.22000000000)},
      {{5, 1}, log(0.28000000000)},
      {{6, 0}, log(1.00000000000)},
      {{6, 1}, log(1.00000000000)},
    ] |> Enum.into(Map.new)
